...
const MEDIA_COMPONENTS = {
  'darwin-arm64': {
    ...
    manifestUrl: 'https://github.com/Hyp-Plus/stem-studio/releases/download/v0.2.2/stem-studio-media-macos-arm64.json'
  },
  'win32-x64': {
    label: 'Windows x64 媒体组件',
    manifestUrl: 'https://github.com/Hyp-Plus/stem-studio/releases/download/v0.2.2/stem-studio-media-windows-x64.json'
  }
};
