...
<h1 align="center">Stem Studio：本地音频分离项目工作台</h1>
...
- **本地项目库（v0.3）**：每次分离都会归入项目，保存素材引用、分离设置、处理结果与混音导出记录；不复制也不上传原始媒体
- **项目结果中心（v0.3）**：在左侧切换项目，中央显示该项目的可用结果；可直接回到工作台继续试听、调音与导出
